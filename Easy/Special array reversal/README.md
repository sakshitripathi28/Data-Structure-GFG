<h2><a href="https://practice.geeksforgeeks.org/problems/special-array-reversal2328/1?utm_source=gfg&utm_medium=article&utm_campaign=bottom_sticky_on_article">Special array reversal</a></h2><h3>Difficulty Level : Easy</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size:18px">Given a string <strong>S</strong>, containing special characters and all the alphabets, reverse the string without<br>
